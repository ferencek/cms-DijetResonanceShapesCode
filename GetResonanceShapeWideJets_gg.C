#include "LineShape_pdf_WideJets_gg.h"
...
void GetResonanceShape_gg()
{
    ...
    TFile *output = new TFile("Resonance_Shapes_WideJets_gg.root","RECREATE");
    ...
    for(int j=0; j<36; j++){
       ...
       h_cdf[j]=new TH1D(TString(histname)+"_cdf", "gg Resonance Shape CDF", 14000, 0, 14000);
