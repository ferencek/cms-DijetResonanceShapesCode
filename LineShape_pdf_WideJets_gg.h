...
#ifndef _LINESHAPE_PDF_H
#define _LINESHAPE_PDF_H


#include "Math/Interpolator.h"
#include "shape_WideJets_gg.h"
...
void setArray (double mass){ 
	...
	//	  cout<<ind<<"\t "<<mjj<<"\t "<<0.3*mass<<endl;
     if(mjj<0.3*mass || mjj>1.3*mass) FoundQstarBinnedProb[ind] = 0.;
